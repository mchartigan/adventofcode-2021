...
with open("input.txt") as file:
    seafloor = [[ch for ch in s.strip()] for s in file.readlines()]
...
while moved:
    loops += 1
    moved = False
    last = deepcopy(seafloor)
    for i in range(0, rows):
        for j in range(0, cols):
            if last[i][j] == 1:
                if j+1 < cols and last[i][j+1] == 0:
                    seafloor[i][j] = 0
                    seafloor[i][j+1] = last[i][j]
                    moved = True
                elif j+1 == cols and last[i][0] == 0:
                    seafloor[i][j] = 0
                    seafloor[i][0] = last[i][j]
                    moved = True
    last = deepcopy(seafloor)
    for i in range(0, rows):
        for j in range(0, cols):
            if last[i][j] == 2:
                if i+1 < rows and last[i+1][j] == 0:
                    seafloor[i][j] = 0
                    seafloor[i+1][j] = last[i][j]
                    moved = True
                elif i+1 == rows and last[0][j] == 0:
                    seafloor[i][j] = 0
                    seafloor[0][j] = last[i][j]
                    moved = True
